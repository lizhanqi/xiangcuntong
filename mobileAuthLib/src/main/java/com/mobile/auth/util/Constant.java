...
public class Constant {
    ...
    public static final String HTTP_BASE_URL = BuildConfig.HTTP_BASE_URL;//现网 https
    //本机号码校验
    public static String HTTP_VALIDATE_TOKEN_URL = BuildConfig.HTTP_VALIDATE_TOKEN_URL;
    public static String VERSION = "1.0";
    public static String APP_ID = BuildConfig.APP_ID; //现网自测
    public static String APP_KEY = BuildConfig.APP_KEY;
    public static String APP_SECRET = BuildConfig.APP_SECRET;
    public static final String URL_CLAUSE = "http://wap.cmpassport.com/resources/html/contract.html";// 中国移动统一认证条款
