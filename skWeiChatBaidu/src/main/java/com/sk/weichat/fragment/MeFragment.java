...
public class MeFragment extends EasyFragment implements View.OnClickListener {
    ...
    private void initView() {
        ...
        RelativeLayout circle_friend = (RelativeLayout) findViewById(R.id.circle_friend);
        RelativeLayout douyin = (RelativeLayout) findViewById(R.id.douyin);
        RelativeLayout official_account = (RelativeLayout) findViewById(R.id.official_account);
        circle_friend.setOnClickListener(this::onClick);
        douyin.setOnClickListener(this::onClick);
        official_account.setOnClickListener(this::onClick);
