...
public class JitsiFloatService extends Service {
    ...
    private void createWindowManager() {
        ...
        Log.e("hm---Width",mFloatWinWidth+"FF");
        Log.e("hm---Height",mFloatWinHeight+"FF");
       ...
       // mLayoutParams.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL;
        //设置可以显示在状态栏上
        mLayoutParams.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams
