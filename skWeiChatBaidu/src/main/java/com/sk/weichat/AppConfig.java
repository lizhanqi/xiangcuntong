...
public class AppConfig {
    ...
    public static String CONFIG_URL = "http://123.57.179.132:8092/config";// Socket IM 服务器入口
    ...
    public String homeAddress;// 主页网址
    public boolean isNoRegisterThirdLogin;// 第三方登录免注册
    public int isOpenUI;
    ...
    public static AppConfig initConfig(ConfigBean configBean) {
        ...
        config.livePageUrl = configBean.getLivePageUrl();
        ...
        config.homeAddress = configBean.getHomeAddress();
