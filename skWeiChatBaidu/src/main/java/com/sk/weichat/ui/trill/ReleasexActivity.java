...
import com.sk.weichat.bean.event.EventTrillRelease;
...
public class ReleasexActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void handlerVideo() {
        ...
        Log.e("xuan", "release: " + mVideoFilePath + " timelen " + mTimeLen + "  thumb :" + mThumbPath);
    ...
    public void sendAudio() {
        ...
        params.put("lable", String.valueOf(mCurrTag));
    ...
    public void compRelease(String data) {
        Toast.makeText(this, getString(R.string.tip_public_success), Toast.LENGTH_SHORT).show();
        DialogHelper.dismissProgressDialog();
        Intent intent = new Intent();
        intent.putExtra(AppConstant.EXTRA_MSG_ID, data);
        setResult(RESULT_OK, intent);
        MsgBroadcast.broadcastMsgColseTrill(this);
        EventBus.getDefault().post(new EventTrillRelease());
        finish();
    }
