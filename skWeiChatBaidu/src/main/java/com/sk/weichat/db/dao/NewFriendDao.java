...
public class NewFriendDao {
    ...
    public void updateNewFriendContent(String friendId, String content, double timeSend) {
        UpdateBuilder<NewFriendMessage, Integer> builder = newFriendDao.updateBuilder();
        String myId = CoreManager.requireSelf(MyApplication.getInstance()).getUserId();
        try {
...
*/
            ...
            if (existFriend != null) {
                ...
                if (!TextUtils.isEmpty(newFriend.getContent())) {
                    updateNewFriendContent(newFriend.getUserId(), newFriend.getContent(), newFriend.getDoubleTimeSend());
                }
                return true;
            } else {
    ...
    public void addFriendOperating(String userId, String nickName, String remarkName) {
        ...
        FriendDao.getInstance().updateLastChatMessage(mLoginUserId, userId, MyApplication.getInstance().getString(R.string.be_friendand_chat));
