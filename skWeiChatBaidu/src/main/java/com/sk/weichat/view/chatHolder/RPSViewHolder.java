...
public class RPSViewHolder extends AChatHolderInterface {
    ...
    public void fillData(ChatMessage message) {
        if (!message.isDownload()) {
            mImageView.setBackgroundResource(R.drawable.rps_frame);
    ...
    private void drawableDice(String message) {
        ...
        int id = MyApplication.getContext().getResources().getIdentifier("jsb_" + value,
