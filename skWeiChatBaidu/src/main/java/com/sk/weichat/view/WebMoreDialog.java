...
public class WebMoreDialog extends Dialog {
    ...
    public WebMoreDialog(Context context, String url, boolean isHideFloatWindow, BrowserActionClickListener browserActionClickListener) {
        super(context, R.style.BottomDialog);
        this.mContent = context;
        this.mUrl = url;
        this.isHideFloatWindow = isHideFloatWindow;
        this.mBrowserActionClickListener = browserActionClickListener;
        mData = getData();
    }
